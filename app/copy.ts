export const copy = {
  ...
  faq: [
    ...
    },
    {
      ...
      answer: "CrabHacks was started by Jaden Hou and Tinu Vanapamula as a merger and continuation of older hackathons, Blair Hacks and Poolesville Hacks. In 2024, Jaden Hou, Sarthak Pal Mahajan, and Abhi Ghosh organized the first CrabHacks which had over 50 attendees and was sponsored by Sentry, Capital Workspaces, UVA, Steve Shen, and Jun Hou.",
    },
  ],
  sponsors: [
    // tier 1 — platinum
  ...
  schedule: [
    { time: "sunday 9:00 am", event: "student check-in & breakfast", day: "sunday" },
    { time: "sunday 9:30 am", event: "opening ceremony", day: "sunday" },
    { time: "sunday 9:45 am", event: "hacking begins", day: "sunday" },
    { time: "sunday 12:30 pm", event: "speaker: baker bruce, founder of thea", day: "sunday" },
    { time: "sunday 1:00 pm", event: "lunch (panda express)", day: "sunday" },
    { time: "sunday 2:00 pm", event: "fireside chat: cory levy, angel investor founder of z fellows", day: "sunday" },
    { time: "sunday 2:30 pm", event: "worktime", day: "sunday" },
    { time: "sunday 4:00 pm", event: "ice cream w/ annie park, owner of sarah's handmade ice cream", day: "sunday" },
    { time: "sunday 4:45 pm", event: "presentations start (early birds)", day: "sunday" },
    { time: "sunday 5:00 pm", event: "hacking ends & submissions due. presentations continue", day: "sunday" },
    { time: "sunday 6:00 pm", event: "dinner (dominos)", day: "sunday" },
    { time: "sunday 6:45 pm", event: "closing ceremony & prizes", day: "sunday" },
    { time: "sunday 7:00 pm", event: "crabhacks ends", day: "sunday" },
  ],
  tracks: [
  ...
  team: [
    ...
    { name: "mishelle munkhbat", role: "marketing lead" },
